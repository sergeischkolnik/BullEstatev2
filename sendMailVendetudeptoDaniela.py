...
def sendMailGratis(to,nombreProp,link):
    fromaddr = "daniela@vendetudepto.cl"
    toaddr = to
    ...
    body1 += "Mi nombre es Daniela, trabajo en Vendetudepto.cl, y como promoción de lanzamiento, estamos ofreciendo servicios Totalmente Gratuitos de difusión inmobiliaria.\n\n"
    ...
    body1 += "Si tienes interés, te solicito enviar toda la información de tu propiedad a mi correo daniela@vendetudepto.cl (precio, características, horarios de visita, fotografías, etc), y con gusto asignaremos un corredor para tu propiedad. Junto con esto, rogamos enviarnos tu número de contacto.\n\n"
    body1 += "Ante cualquier dudas, por favor escríbeme al correo o a nuestro WhatsApp +569 7756 0015.\n"
    ...
    server.login(fromaddr, "17000441")
    text = msg.as_string()
