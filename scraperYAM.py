...
def main(tipoRec="departamento",operacionRec="venta", regionRec="metropolitana",pagRec=1,isRecovery=False):
    ...
    while(True):
        link='https://www.yapo.cl/region_metropolitana/arrendar?ca=15_s&l=0&w=1&cmn='
        ...
        for i in ran:
            ...
            link2='https://www.yapo.cl/region_metropolitana/arrendar?ca=15_s&cg=1220&o='+str(i)
            session = HTMLSession()
            r = session.get(link2)
            links3 = []
            duenos = []
            ...
            for link3,dueno in props:
                ...
                propiedad.append(int(metrosmin))
                propiedad.append(int(metrosmax))
                propiedad.append(int(dormitorios))
                propiedad.append(int(banos))
                propiedad.append(int(estacionamientos))
                ...
                try:
                    ...
                    pass
                print("[SYAM] insertada propiedad id:" + str(propiedad[0]) + " " +str(i) + "/" + str(last))
