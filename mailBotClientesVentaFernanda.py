...
def sendClientMailsCasas():
    ...
    print("[mailerFer][" + str(datetime.now()) +"]Sending mails (casas) to "+str(len(lista))+ " clients:")
...
def sendClientMailsOficinas():
    ...
    print("[mailerFer][" + str(datetime.now()) +"]Sending mails (oficinas) to "+str(len(lista))+ " clients:")
