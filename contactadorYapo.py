...
if __name__ == "__main__":
    ...
    for i in range (5,200):
        ...
        inicialLinkSantiago='https://www.yapo.cl/region_metropolitana/comprar?ca=15_s&cmn=305&cmn=306&cmn=307&cmn=309&cmn=310&cmn=313&cmn=315&cmn=316&cmn=319&cmn=320&cmn=323&cmn=330&cmn=335&cmn=340&cmn=343&cmn=346&ret=1&cg=1220&f=p&o='+str(i)
        inicialLinkVentaDeptoValpo='https://www.yapo.cl/valparaiso/comprar?ca=6_s&cmn=52&cmn=79&cmn=81&ret=1&cg=1220&f=p&o='+str(i)
        inicialLinkArriendoDeptoValpo='https://www.yapo.cl/valparaiso/comprar?ca=6_s&cmn=52&cmn=79&cmn=81&ret=1&cg=1240&f=p&o='+str(i)

        print(inicialLinkArriendoDeptoValpo)
        page=requests.get(inicialLinkArriendoDeptoValpo, headers=headers1)
        idlist=[]
