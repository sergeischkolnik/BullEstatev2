...
if __name__ == '__main__':
    ...
    generarReporteInterno(preciomin=40000000, preciomax=110000000,utilmin=0,utilmax=99,totalmin=0,totalmax=99,latmin=-9999,
                   ...
                   nombreCliente='nunoa-2-1',verboso=True)
