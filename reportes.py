...
if __name__ == '__main__':
    ...
    generarReporteInterno(preciomin=30000000, preciomax=80000000,utilmin=0,utilmax=99,totalmin=0,totalmax=99,latmin=-9999,
                   ...
                   nombreCliente='san-miguel-2-1',verboso=True)
