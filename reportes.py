...
if __name__ == '__main__':
    ...
    generarReporteInterno(preciomin=30000000, preciomax=60000000,utilmin=0,utilmax=99,totalmin=0,totalmax=99,latmin=-9999,
                   ...
                   nombreCliente='san-miguel-1-1',verboso=True)
