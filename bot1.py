                ...
                #tasador
                    ...
                    if len(arr)< 16:
                        ...
                        if n>=0:
                            ...
                            precio,nivel,nrcomp,links,coef = tb2.calcularTasacion(operacion=operacion,tipo=tipo,lat=float(lat),lon=float(lon),util=float(mtUtiles),
                            ...
                            text = "El precio tasado es UF " + str(precio)+", con un nivel de confianza: "+str(nivel)+\
                                   ", tasación realizada comparandose con "+str(nrcomp)+" propiedades.Los coeficientes fueron:"+str(coef)
                        else:
