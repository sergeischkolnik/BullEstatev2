...
def sendClientMailsDeptos():
    sql = "select duenos.mail,portalinmobiliario.nombre,portalinmobiliario.link from duenos inner join portalinmobiliario where " \
          ...
          "duenos.esDueno='si' and (portalinmobiliario.operacion='venta' or portalinmobiliario.operacion='venta') and portalinmobiliario.tipo='departamento' and " \
          ...
          "portalinmobiliario.link like '%providencia%' or " \
           "portalinmobiliario.link like '%las-condes%' or portalinmobiliario.link like '%vitacura%' or portalinmobiliario.link like 'lo-barnecgea');"
