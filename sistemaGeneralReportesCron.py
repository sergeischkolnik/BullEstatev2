...
def main(verboso):
    ...
    for cliente in clientes:
        ...
        reportes.generarReporteSeparado(preciomin=cliente[5], preciomax=cliente[6], utilmin=cliente[7], utilmax=cliente[8],
                               ...
                               region=cliente[24], listaComunas=comunas, prioridad=cliente[39], mail=cliente[3],nombreCliente=cliente[1],nombrecarpetadb=cliente[45],
                               idCliente=cliente[0], direccion=cliente[42], radioDireccion=cliente[43],corredor=cliente[41],topx=cliente[44], verboso=verboso,separado=separado)
