...
def sendMailGratis(to,nombreProp,link):
    ...
    body1 += "Mi nombre es Francisca, trabajo en Vendetudepto.cl, y como promoción de lanzamiento, estamos ofreciendo servicios Totalmente Gratuitos de difusión inmobiliaria.\n\n"
    ...
    body1 += "Si tienes interés, te solicito enviar toda la información de tu propiedad a mi correo francisca@vendetudepto.cl (precio, características, horarios de visita, fotografías, etc), y con gusto asignaremos un corredor para tu propiedad. Junto con esto, rogamos enviarnos tu número de contacto.\n\n"
