...
def sendMailGratis(to,nombreProp,link):
    ...
    body1 += "Si tienes interés, te solicito enviar toda la información de tu propiedad a mi correo fernanda@vendetudepto.cl (precio, características, horarios de visita, fotografías, etc), y con gusto asignaremos un corredor para tu propiedad. Junto con esto, rogamos enviarnos tu número de contacto.\n\n"
