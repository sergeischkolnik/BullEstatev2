...
SELECT_PRICE_RANGE, SELECT_AREA_RANGE,CONFIRM_REPORT,ADVANCE,SELECT_SITE,SELECT_ID,CONFIRM_FILE,SELECT_FEATURE,SELECT_AREA,SELECT_ADRESS,CONFIRM_TASACION = range(21)
