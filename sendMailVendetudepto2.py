...
def sendMailGratis(to,nombreProp,gratis):
    ...
    body1 += "Mi nombre es Carolina de vendetudepto.cl. Como promoción de lanzamiento, estamos ofreciendo servicios gratuitos de difusión inmobiliaria.\n\n"
    ...
    body1 += "Si tienes interés o quieres resolver dudas, por favor escríbeme a mi correo carolina@vendetudepto.cl o a nuestro WhatsApp +569 8936 6288, y con gusto te atenderé personalmente.\n"
